...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li>Laporan</li>
		<li class="active">Laporan Distribusi</li>
	</ol>
</section>
                    ...
                    <table id="table1" class="table table-bordered table-striped">
						...
						<tbody>
                            <tr>
                                ...
                                <td>
                                    <ul>
                                        <li>Urea Pustri 5kg - 15</li>
                                        <li>Urea Pustri 10kg - 5</li>
                                        <li>Urea Pustri 50kg - 1</li>
                                    </ul>
                                </td>
                                <td style="text-align:center">175 Kg</td>
                                <td style="text-align:center">07 Juli 2020</td>
                            </tr>
                            <tr>
                                <td style="text-align:center">2</td>
                                <td>
                                    <ul>
                                        <li>NPK Pusri 25kg - 20</li>
                                        <li>Urea Pustri 50kg - 10</li>
                                        <!-- <li>Urea Pustri 10kg - 10</li> -->
                                    </ul>
                                </td>
                                <td style="text-align:center">1000 Kg</td>
                                <td style="text-align:center">08 Juli 2020</td>
                            </tr>
                            <!-- <tr>
